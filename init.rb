...
# create quests
# Quest.new(name: 'Welcome', level: 1, location: [13,13], map_name: tc.name, requirements:{'kills':10},
#           dialogue: 'welcome to consolerpg. comeplete the quest by getting 10 kills',
