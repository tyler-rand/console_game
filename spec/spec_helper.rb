...
FACADES_TO_REQUIRE = ['battle_displayer', 'event_trigger', 'inventory_interactor',
  'map_display_range_finder', 'map_displayer', 'map_menu', 'map_movement', 'message_log',
  'quest_log', 'vendor_buy_interaction', 'vendor_interactor', 'vendor_sell_interaction']
FACADES_TO_REQUIRE.each { |facade| require_relative "../facades/#{facade}" }
